...
const SPECIFIC_AREAS_MAP: Record<string, string[]> = {
    ...
    'pierna-derecha': ['Cadera Derecha', 'Muslo Derecho', 'Rodilla Derecha', 'Tobillo Derecho'],
    'pierna-izquierda': ['Cadera Izquierda', 'Muslo Izquierdo', 'Rodilla Izquierda', 'Tobillo Izquierdo'],
    'espalda-superior': ['Trapecio', 'Dorsal'],
};
...
const BodyMapFront = ({ onClick, selectedParts }: { onClick: (part: string) => void; selectedParts: string[] }) => {
    const BodyPart = ({ id, d, ...props }: { id: string; d: string; [key: string]: any }) => {
