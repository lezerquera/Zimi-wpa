...
import { DoctorProfile, Service, Appointment, ClinicInfo, ChatMessage, Notification, Insurance, User } from './types.ts';
import { PatientView } from './pages/PatientView.tsx';
import AdminView from './pages/AdminView.tsx';
import { Logo, LogOutIcon } from './components/Icons.tsx';
